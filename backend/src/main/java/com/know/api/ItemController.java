...
public class ItemController {
  ...
  public ResponseEntity<KnowledgeService.ItemView> create(
      Authentication a, @Valid @RequestBody ItemRequest r) {
  ...
  public KnowledgeService.ItemView update(
      Authentication a, @PathVariable UUID id, @Valid @RequestBody ItemRequest r) {
  ...
  public KnowledgeService.ItemView progress(
      Authentication a, @PathVariable UUID id, @Valid @RequestBody ProgressRequest r) {

...
class OwnershipBehaviorTest {
    ...
    @Test void timerRejectsSecondRunningTimerForSameUser() {
        ...
        TimerService service=new TimerService(entries,paths,items,mock(ProgressEntryRepository.class),activities);
    ...
    @Test void timerPreservesClientSource() {
        ...
        TimerService.TimeView result=new TimerService(entries,paths,items,mock(ProgressEntryRepository.class),activities).start(user,null,null,"iOS",TimeSource.IOS);
    ...
    @Test void statisticsIncludesCompletionCountsAndRecentProgress() {
        ...
        TimerService.Statistics result=new TimerService(entries,paths,items,progress,activities).statistics(user);

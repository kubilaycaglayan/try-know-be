...
const required = [
  ...
  ['frontend/src/views/DashboardView.vue', 'aria-label="Clockify JSON"', 'Clockify import input label'],
  ['frontend/src/views/DashboardView.vue', 'Import Clockify sessions', 'Clockify import action label'],
